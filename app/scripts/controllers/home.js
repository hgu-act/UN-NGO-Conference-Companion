...
angular.module('ngoConferenceCompanionApp')
  .controller('HomeCtrl', function (resource, $log, timeAgo) {
    ...
    homeVM.currentEvent = {
      ...
      backgroundStyle: {
        'background': 'url("https://s3.ap-northeast-2.amazonaws.com/ngo-app/assets/opening-session.png") center / cover',
        'height': '176px'
      }
    };
    homeVM.nextEvent = {
      ...
      place: 'Around HICO',
      backgroundStyle: {
        'background': 'url("https://s3.ap-northeast-2.amazonaws.com/ngo-app/assets/lunch.png") center / cover',
        'height': '176px'
      }
    };
